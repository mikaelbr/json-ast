...
(* OASIS_START *)
(* DO NOT EDIT (digest: bfeac6bafc2871f26692b91b6b52188f) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_json_ast", ["-q"]))];
     ...
     oasis_version = "0.4.8";
     oasis_digest =
       Some "\210lv^\023\026\174\254\185\018\233\158\136\189\175\145";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
