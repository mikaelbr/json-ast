...
(* OASIS_START *)
(* DO NOT EDIT (digest: fe5ac6f11f7973881f6373234bac6707) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_json_ast", []))];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/mikaelbr/json-ast";
          bugreports = None;
          synopsis = "Package for creating ASTs from JSON";
          description =
            Some [OASISText.Para "Package for creating ASTs from JSON."];
          tags = [];
          categories = [];
          files_ab = [];
          sections =
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Json_ast"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "json_ast";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "test_json_ast";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "src_test";
                      bs_compiled_object = Best;
                      bs_build_depends = [FindlibPackage ("alcotest", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
               ...
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_working_directory = Some "src_test";
                      test_run =
                        [
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "test_json_ast"
                        ]
                   });
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/mikaelbr/json-ast.git";
                      src_repo_browser =
                        Some "https://github.com/mikaelbr/json-ast";
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "_\173\184Ef.l\245\210H~&R\160\199\023";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
